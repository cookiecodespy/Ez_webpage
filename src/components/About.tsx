      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-8 mb-20">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.8 }}
          >
            {/* ISO Badge - Gradient border card */}
        ...
        {/* Áreas clave - Floating gradient border cards */}
        <div className="grid lg:grid-cols-2 gap-8 mb-20">
          {[
            {
              icon: <Sparkles className="h-8 w-8 text-white" />,
              title: "Importaciones & Exportaciones",
              description: "Integrando control documental, auditorías internas y evaluación de desempeño continuo para garantizar excelencia en cada operación internacional.",
              gradient: "from-blue-500 via-indigo-500 to-purple-500"
            },
            {
              icon: <Award className="h-8 w-8 text-white" />,
              title: "Centro de Almacenaje y Distribución",
              description: "Servicios logísticos confiables y seguros con mejora constante, alineados con las mejores prácticas de la industria.",
            ...
            >
              ...
              <div className="relative rounded-3xl overflow-hidden">
                ...
                <div className="absolute inset-[2px] rounded-3xl overflow-hidden">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-gray-50 to-transparent rounded-full blur-3xl opacity-60" />
                ...
                <div className="relative p-10">
                  <div className="flex items-start gap-6">
                    <div className={`flex-shrink-0 w-16 h-16 rounded-2xl bg-gradient-to-br ${area.gradient} flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500`}>
                      {area.icon}
                    </div>
                    <div className="flex-1">
        ...
        {/* Misión y Visión - Glassmorphism cards with gradient borders */}
        <div className="grid lg:grid-cols-2 gap-8 mb-20">
          {[
            {
              icon: <Target className="h-8 w-8 text-white" />,
              title: "Misión",
              description: "Superar las expectativas de servicio de nuestros clientes, satisfaciendo las necesidades en toda la cadena de suministro a través de soluciones que se aplican a los diferentes requerimientos.",
              gradient: "from-cyan-500 via-blue-500 to-indigo-500",
              meshColor: "from-cyan-50"
            },
            {
              icon: <Eye className="h-8 w-8 text-white" />,
              title: "Visión",
              description: "Lograr que el grupo EZ Ship Logistics cree un ambiente de amor y felicidad donde sus colaboradores puedan desarrollarse profesional y personalmente, extendiendo este ambiente a su entorno de manera sustentable y sostenible en el tiempo.",
            ...
            >
              ...
              <div className="relative rounded-3xl overflow-hidden">
                ...
                {/* Mesh gradient background */}
                <div className="absolute inset-[2px] rounded-3xl overflow-hidden">
                  <div className={`absolute top-0 right-0 w-80 h-80 bg-gradient-to-br ${item.meshColor} to-transparent rounded-full blur-3xl opacity-40`} />
                  <div className={`absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr ${item.meshColor} to-transparent rounded-full blur-2xl opacity-30`} />
                </div>
                
                {/* Content */}
                <div className="relative p-10">
                  <div className="flex items-start gap-6">
                    <div className={`flex-shrink-0 w-16 h-16 rounded-2xl bg-gradient-to-br ${item.gradient} flex items-center justify-center shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
                      {item.icon}
                    </div>
                    <div className="flex-1">
        ...
        {/* Valores - Bento grid asymmetric layout */}
        <div>
          <h3 className="text-3xl font-bold text-gray-900 text-center mb-12">Nuestros valores</h3>
          <div className="grid lg:grid-cols-3 gap-6">
            {values.map((value, index) => {
              // Create bento layout pattern - vary card sizes
              const isLarge = index === 0 || index === 3; // First and fourth cards are large
