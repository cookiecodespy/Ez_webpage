...
const servicesData: Record<string, ServiceDetailData> = {
  ...
  'fulfillment-ecommerce': {
    ...
    title: 'Fulfillment E-commerce',
    subtitle: 'Tu centro de operaciones logísticas online',
    heroImage: 'https://images.unsplash.com/photo-1553413077-190dd305871c?q=80&w=1600&fm=webp',
    description: 'Solución integral para tiendas online que permite externalizar toda la logística. Nos encargamos del almacenaje, preparación de pedidos, empaque personalizado y envío directo a tus clientes finales, permitiéndote enfocarte en vender mientras nosotros nos ocupamos de la operación.',
    stats: [
      { value: '24/7', label: 'Procesamiento Pedidos' },
      { value: '99.5%', label: 'Precisión Picking' },
      { value: 'Same Day', label: 'Despacho Express' },
      { value: '15K+', label: 'Pedidos Mensuales' }
    ],
    features: [
      {
        icon: <Package className="h-8 w-8" />,
        title: 'Almacenaje Flexible',
        description: 'Bodega compartida o dedicada según volumen, sin contratos largos'
      },
      {
        icon: <TrendingUp className="h-8 w-8" />,
        title: 'Picking & Packing',
        description: 'Preparación de pedidos con validación de calidad y empaque personalizado'
      },
      {
        icon: <Clock className="h-8 w-8" />,
        title: 'Integración API',
        description: 'Conexión automática con Shopify, WooCommerce, Mercado Libre y más'
      },
      {
        icon: <Users className="h-8 w-8" />,
        title: 'Dashboard en Tiempo Real',
        description: 'Visibilidad completa de inventario, pedidos y envíos desde tu panel'
      }
    ],
    process: [
      {
        ...
        description: 'Ingreso de productos con inspección, etiquetado y registro en sistema'
      },
      {
        step: 2,
        title: 'Almacenamiento Optimizado',
        description: 'Ubicación estratégica según rotación y características de productos'
      },
      {
        step: 3,
        title: 'Integración Tienda Online',
        description: 'Sincronización automática de pedidos desde tu plataforma e-commerce'
      },
      {
        step: 4,
        title: 'Preparación de Pedidos',
        description: 'Picking, empaque personalizado y generación de etiquetas de envío'
      },
      {
        step: 5,
        title: 'Despacho y Tracking',
        description: 'Envío same-day con número de seguimiento y notificaciones al cliente'
      }
    ],
    benefits: [
      'Reduce costos al eliminar necesidad de bodega propia y personal',
      'Escalabilidad inmediata para manejar picos de demanda estacionales',
      'Mejora experiencia del cliente con envíos rápidos y profesionales',
      'Ahorra tiempo para enfocarte en marketing y ventas',
      'Gestión de devoluciones y reintegro a inventario',
      'Reportes detallados de KPIs logísticos y rotación de productos',
      'Empaque personalizado con tu branding (cajas, stickers, inserts)'
    ],
    gallery: [
      { image: 'https://images.unsplash.com/photo-1553413077-190dd305871c?q=80&w=800&fm=webp', caption: 'Centro de fulfillment moderno' },
      { image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=800&fm=webp', caption: 'Preparación de pedidos e-commerce' },
      { image: 'https://images.unsplash.com/photo-1565793298595-6a879b1d9492?q=80&w=800&fm=webp', caption: 'Empaque personalizado para marcas' }
    ]
  }
};
